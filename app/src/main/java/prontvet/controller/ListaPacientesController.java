...
public class ListaPacientesController {
    ...
    private void criarMenuContexto() {
        ...
        item.setOnAction(e -> editarPaciente());

        MenuItem item2 = new MenuItem("Excluir");
        item2.setOnAction(e -> excluirPaciente());
    ...
    private void editarPaciente() {
        ...
        if (pacienteEntity == null) {
            Util.showError("Selecione um paciente para editar!");
            return;
        }
    ...
    private void excluirPaciente() {
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                PacienteEntity pacienteEntity = table.getSelectionModel().getSelectedItem();
                if (pacienteEntity == null) {
                    Util.showError("Selecione um paciente para excluir!");
                    return;
                }
